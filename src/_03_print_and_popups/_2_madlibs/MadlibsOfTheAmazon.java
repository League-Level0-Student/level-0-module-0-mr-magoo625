...
String input= JOptionPane.showInputDialog("Please enter an adjective to continue story");
		// Get the player to enter a type of liquid
input= JOptionPane.showInputDialog("Please enter a type of liquid to continue story");
		// Get the player to enter a body part
input= JOptionPane.showInputDialog("Please enter a part of the body to continue story");
		// Get the player to enter a verb
input= JOptionPane.showInputDialog("Please enter an verb to continue story");
		// Get the player to enter a place
input= JOptionPane.showInputDialog("Please enter a place to continue story");
		...
		"night. Piranhas are attracted to fresh [**input**] and will most\n"  +
		"likely take a bite out of your [input**] if you [input]. Whatever\n"  +
